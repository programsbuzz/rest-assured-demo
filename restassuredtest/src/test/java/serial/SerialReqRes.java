...
SerializationPOJO spo = new SerializationPOJO("Sasuke", "aa@alal.com","male","active"); //change email address before post sir everytime.
...
response2 = RestAssured.get("https://gorest.co.in/public/v1/users?email=aa@alal.com");
...
SerializationPOJO spo2 = RestAssured.given().get("https://gorest.co.in/public/v1/users/"+id).as(SerializationPOJO.class);
System.out.println("****************************");
